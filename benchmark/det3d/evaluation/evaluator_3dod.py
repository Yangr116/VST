"""
Most of the code is sourced from https://github.com/facebookresearch/omni3d/blob/main/cubercnn/evaluation/omni3d_evaluation.py
Ray Yang removed the dependency on detectron2.
"""
import time
import copy
import torch
...
import itertools
from benchmark.det3d.evaluation.utils import create_small_table
...
def _evaluate_predictions_on_omni(
    ...
    modes = ["3D"] if only_3d else ["2D", "3D"]
...
def _derive_omni_results(omni_eval, iou_type, mode, class_names=None):
    """
