...
class Qwen2_5_VLFlashAttention2(Qwen2_5_VLAttention):
    ...
    def forward(
        ...
        # ulysses sp patch: use customized flash attention
    ...
    def flash_attention_forward(
        ...
        **kwargs,
        ...
        if position_ids is not None and query_length != 1 and not (torch.diff(position_ids[0], dim=-1) >= 0).all():
            ...
            query_states, key_states, value_states, _, cu_seq_lens, max_seq_lens = self._prepare_fa2_from_position_ids(
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def get_position_id_func(self):  # used in data_transform during training
        ...
        return partial(get_position_id, Qwen2_5_VLForConditionalGeneration.get_rope_index, fake_model)
        ...
        **kwargs,
        ...
        if labels is not None:
            ...
            if is_liger_kernel_available():
                ...
                hidden_states = hidden_states.view(-1, self.config.hidden_size)  # flatten hidden states
                ...
                logits = logits.float().view(-1, self.config.vocab_size)  # flatten logits
